...
def build_model(inputs, args, mode, params):
    ...
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 256 // scale_factor)
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 256 // scale_factor)
    net = builder.max_pool(net)
    ...
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 728 // scale_factor)
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 728 // scale_factor)
    net = builder.max_pool(net)
    net = net + residual
    ...
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 728 // scale_factor)
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 1024 // scale_factor)
    net = builder.max_pool(net)
    ...
    net = builder.separable_conv2d_bn(tf.nn.elu(net), 2048 // scale_factor)
