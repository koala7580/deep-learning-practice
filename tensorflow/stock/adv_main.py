...
# tf.estimator.train_and_evaluate is the replacement of Experiment.
...
def get_model_fn(num_gpus, variable_strategy, num_workers):
  ...
  def _model_fn(features, labels, mode, params):
	...
	with tf.device(consolidation_device):
	  ...
	  num_batches_per_epoch = dataset.DataSet.num_examples_per_epoch(
...
def input_fn(data_dir,
  ...
  with tf.device('/cpu:0'):
	...
	dataset = dataset.DataSet(data_dir, subset, use_distortion)
